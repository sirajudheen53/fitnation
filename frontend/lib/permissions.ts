...
export const ROUTE_PERMISSIONS: Record<string, string[]> = {
  ...
  "/reviews": ["reviews.view_review"],
  "/workouts": ["workouts.view_workout"],
  "/workouts/plans/new": ["workouts.create_workout"],
  "/workouts/plans/[id]/edit": ["workouts.edit_workout"],
  "/workouts/assign": ["workouts.create_workout"],
  "/workouts/log": ["workouts.view_workout"],
  "/exercises": ["exercises.view_exercise"],
  "/exercises/new": ["exercises.edit_exercise"],
  "/diets": ["diets.view_diet"],
  "/diet": ["diets.view_diet"],
  "/diet/food-items": ["diets.view_diet"],
  "/diet/plans/new": ["diets.create_diet"],
  "/diet/plans/[id]/edit": ["diets.edit_diet"],
  "/diet/assign": ["diets.create_diet"],
